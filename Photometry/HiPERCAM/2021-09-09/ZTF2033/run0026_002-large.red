...
# File written on 28 Oct 2021 15:26:22 (UTC)
#
...
[apertures]
aperfile = run0026_002-large.ape # file of software apertures for each CCD
...
search_smooth_fwhm = 2.9 # smoothing FWHM, binned pixels
...
fit_fwhm_min = 4.5 # Minimum FWHM, unbinned pixels [MUST be < fit_fwhm!]
...
[extraction]
1 = variable normal 1.80 9.0 44.4 2.5 44.4 44.4 3.0 66.7 66.7
2 = variable normal 1.80 9.0 44.4 2.5 44.4 44.4 3.0 66.7 66.7
3 = variable normal 1.80 9.0 44.4 2.5 44.4 44.4 3.0 66.7 66.7
4 = variable normal 1.80 9.0 44.4 2.5 44.4 44.4 3.0 66.7 66.7
5 = variable normal 1.80 9.0 44.4 2.5 44.4 44.4 3.0 66.7 66.7
...
bias = masterBiasWD.hcm # Bias frame, blank to ignore
