...
# File written on 27 Oct 2021 11:05:17 (UTC)
#
...
[apertures]
aperfile = run0008_010.ape # file of software apertures for each CCD
location = variable # aperture locations: 'fixed' or 'variable'

search_half_width = 21.0 # for initial search for objects around previous position, unbinned pixels
...
fit_max_shift = 5.2 # max. non-ref. shift, unbinned pixels.
fit_alpha = 0.10 # Fraction of non-reference aperture shift to apply
fit_diff = 3.50 # Maximum differential shift of multiple reference apertures, unbinned
...
[extraction]
1 = variable normal 1.80 3.0 37.8 2.5 37.8 37.8 3.0 56.7 56.7
2 = variable normal 1.80 3.0 37.8 2.5 37.8 37.8 3.0 56.7 56.7
3 = variable normal 1.80 3.0 37.8 2.5 37.8 37.8 3.0 56.7 56.7
4 = variable normal 1.80 3.0 37.8 2.5 37.8 37.8 3.0 56.7 56.7
5 = variable normal 1.80 3.0 37.8 2.5 37.8 37.8 3.0 56.7 56.7
